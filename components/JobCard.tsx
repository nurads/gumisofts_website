...
const JobCard: React.FC<JobCardProps> = ({ job, onApply }) => {
    ...
    return (
        <motion.div
            ...
            className="group relative bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 hover:border-purple-400/50 transition-all duration-500 shadow-xl"
        >
            ...
            <div className="flex justify-between items-start mb-6">
                <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-300 mb-4">
                        <span className="flex items-center gap-2 bg-white/10 px-3 py-2 rounded-full border border-white/20">
            ...
            <p className="text-gray-200 mb-6 line-clamp-3 leading-relaxed">{job.description}</p>
            ...
            <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center justify-between text-sm text-gray-300 bg-white/5 rounded-2xl p-4 border border-white/10">
            ...
            <div className="flex gap-4">
                ...
                <button className="px-6 py-3 border-2 border-white/30 hover:border-white/60 text-white hover:bg-white/10 rounded-lg font-semibold transition-all duration-300">
                    Details
                </button>
            </div>
        </motion.div>
